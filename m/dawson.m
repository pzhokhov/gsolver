function ret_val = dawson (x)
 if (length(x(:))>1)
     ret_val = zeros(size(x)); 
     for i=1:length(ret_val(:));
         ret_val(i)=dawson(x(i));
     end;
     return;
 end;
    zero = 0.;
    p1 = [ .9999999999999999444888487, ...
    ...
    q1 = [1.,.5277985804127346830538769, ...
    ...
    twel25 = 12.25;
    six25 = 6.25;
    zcon = .5000000000000000277555756;
    sys071 = 1.34078079e155;
    sys073 = 2.2227587494851e-162;
    ...
    if (y >= six25) 
        if (y >= twel25)  
            ...
            frac = zero;
            for i__ = 1:9;
                frac = q3(i__) / (p3(i__) + y + frac);
            end
            ret_val = (p3(10) + frac) / x;
            return; 
        end
        frac = zero;
        for i__ =1:8;  
            frac = q2(i__) / (p2(i__) + y + frac);
        end
        ret_val = (p2(9) + frac) / x;
        return;
    end
...
%/* L5: */
    sump = ((((((((p1(10) * y + p1(9)) * y + p1(8)) * y + p1(7)) * y + p1(6)) * ...
             y + p1(5)) * y + p1(4)) * y + p1(3)) * y + p1(2)) * y + p1(1);
    sumq = ((((((((q1(10) * y + q1(9)) * y + q1(8)) * y + q1(7)) * y + q1(6)) * ...
             y + q1(5)) * y + q1(4)) * y + q1(3)) * y + q1(2)) * y + q1(1);
    ret_val = x * sump / sumq;
    return; 
