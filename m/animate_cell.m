function f = animate_cell(X,imagefn, title_templ)
...
set(h,'KeyPressFcn', @(hObject, eventdata)keypress_fcn(hObject, eventdata, imagefn, X, title_templ));
set(h,'Tag', 'animatefig_n1');
title(sprintf(title_templ, 1));

return;

function keypress_fcn(hObject, eventdata, imagefn, X, title_templ)
